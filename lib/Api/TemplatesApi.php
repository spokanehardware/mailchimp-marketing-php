...
class TemplatesApi
{
    ...
    protected function deleteTemplateRequest($template_id): \GuzzleHttp\Psr7\Request
    {
    ...
    protected function listRequest($fields = null, $exclude_fields = null, $count = '10', $offset = '0', $created_by = null, $since_date_created = null, $before_date_created = null, $type = null, $category = null, $folder_id = null, $sort_field = null, $sort_dir = null): \GuzzleHttp\Psr7\Request
    {
    ...
    protected function getTemplateRequest($template_id, $fields = null, $exclude_fields = null): \GuzzleHttp\Psr7\Request
    {
        // verify the required parameter 'template_id' is set
        if ($template_id === null || (is_array($template_id) && count($template_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    protected function getDefaultContentForTemplateRequest($template_id, $fields = null, $exclude_fields = null): \GuzzleHttp\Psr7\Request
    {
        // verify the required parameter 'template_id' is set
        if ($template_id === null || (is_array($template_id) && count($template_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    protected function updateTemplateRequest($template_id, $body): \GuzzleHttp\Psr7\Request
    {
        // verify the required parameter 'template_id' is set
        if ($template_id === null || (is_array($template_id) && count($template_id) === 0)) {
            throw new \InvalidArgumentException(
