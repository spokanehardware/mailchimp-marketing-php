...
class BatchesApi
{
    ...
    protected function deleteRequestRequest($batch_id): \GuzzleHttp\Psr7\Request
    {
    ...
    protected function statusRequest($batch_id, $fields = null, $exclude_fields = null): \GuzzleHttp\Psr7\Request
    {
        // verify the required parameter 'batch_id' is set
        if ($batch_id === null || (is_array($batch_id) && count($batch_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    protected function startRequest($body): \GuzzleHttp\Psr7\Request
    {
